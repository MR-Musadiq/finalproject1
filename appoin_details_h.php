                        ...
                        <div class="col-lg-12">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $select = "SELECT c.c_id, c_name, c_age, c_gender, c_dob, a_date, a_time, h_name, statusp, operation  
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>
                                            ...
                                            <td><a href='update_appointment_h.php?update_id=$row[c_id]' class='btn btn-primary'>Update</a></td>
                                        </tr>";
                                    }
                                    ?>                            
                                </tbody>
